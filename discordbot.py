...
async def Bosyu(ctx,rule:str,open:str):
      ...
      embed_message = discord.Embed(title=ctx.author.name+' が'+open+'から'+rule+'を開催！',color=7506394,thumbnail="https://www.sankei.com/images/news/180503/plt1805030018-p1.jpg")
