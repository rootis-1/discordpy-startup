...
async def emo5000(ctx,string:str):
      ...
      string = string.replace("あ","<:aa:596981155056582666>").replace("い","<:ii:596981205103017994>")\
                     ...
                     .replace("ゎ","<:wa:596985495129423884>").replace("が","<:ka:596981589150400522>")\
                     .replace("ぎ","<:ki:596981681173561344>").replace("ぐ","<:ku:596981731085647872>")\
                     .replace("げ","<:ke:596981779626328065>").replace("ご","<:ko:596981856939802625>")\
                     .replace("ざ","<:sa:596982045368909834>").replace("じ","<:si:596982100305903616>")\
                     .replace("ず","<:su:596982151052918794>").replace("ぜ","<:se:596982205872472074>")\
                     .replace("ぞ","<:so:596982251233738752>").replace("だ","<:ta:596982409292152852>")\
                     .replace("ぢ","<:ti:596982453088944128>").replace("づ","<:tu:596982489420136448>")\
                     .replace("で","<:te:596982540187860993>").replace("ど","<:to:596982584240766978>")\
                     .replace("ば","<:ha:596983261503160359>").replace("び","<:hi:596983308391415809>")\
                     .replace("ぶ","<:hu:596983343195750400>").replace("べ","<:he:596983385893634049>")\
